...
#define MAX_APPLICATION_SPEED_RPM           3840 /*!< rpm, mechanical */
...
#define PID_TORQUE_KP_DEFAULT               384
#define PID_TORQUE_KI_DEFAULT               64
#define PID_TORQUE_KD_DEFAULT               100
#define PID_FLUX_KP_DEFAULT                 384
#define PID_FLUX_KI_DEFAULT                 64
...
#define PID_SPEED_KP_DEFAULT                900/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
#define PID_SPEED_KI_DEFAULT                40/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
...
/* Phase 2 */
#define PHASE2_DURATION                     2200 /*milliseconds */
#define PHASE2_FINAL_SPEED_UNIT             (900*SPEED_UNIT/U_RPM)
#define PHASE2_FINAL_CURRENT_A              2

/* Phase 3 */
#define PHASE3_DURATION                     0 /*milliseconds */
#define PHASE3_FINAL_SPEED_UNIT             (900*SPEED_UNIT/U_RPM)
